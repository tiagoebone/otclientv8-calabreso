<?php
// CONFIG
$files_dir = "/var/www/html/apiv2/files";
$files_url = "https://calabresot.com/php-api-v2/files";
$files_and_dirs = array("data", "modules","mods", "layouts", "init.lua");
$checksum_file = "checksums.txt";
$checksum_update_interval = 30; // seconds
$binaries = array(
    // "WIN32-WGL" => "Calabreso.exe",
    // "WIN32-EGL" => "Calabreso.exe",
    // "WIN32-WGL-GCC" => "Calabreso.exe",
    // "WIN32-EGL-GCC" => "Calabreso.exe",
    // "WIN64-WGL" => "Calabreso.exe",
    "WIN64-EGL" => "Calabreso.exe",
    // "WIN64-WGL-GCC" => "Calabreso.exe",
    // "WIN64-EGL-GCC" => "Calabreso.exe",
